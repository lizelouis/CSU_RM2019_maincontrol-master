...
typedef struct
{
  game_robot_state_t game_information;   //0x0001,游戏信息？
  robot_hurt_data_t  blood_changed_data; //0x0002，血量改变？
  real_shoot_t       real_shoot_data;    //0x0003,射击？
  real_power_data_t  power_heat_data;    //0x0004,热量
  rfid_detect_t      rfid_data;          //0x0005,RFID
  game_result_t      game_result_data;   //0x0006,比赛结果
  get_buff_t         get_buff_data;      //0x0007,缓存
  robot_position_t   robot_pos_data;     //0x0008,坐标
